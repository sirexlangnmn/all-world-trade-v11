!(function (t, e) {
    ...
    function m(t, e) {
        ...
        return (
            u() || 'width' !== e
                ...
                : (s += n(i.paddingLeft) + n(i.paddingRight) + n(i.borderLeftWidth) + n(i.borderRightWidth)),
            s
        );
    }
    ...
    class w extends i {
        constructor(t) {
            ...
            ((this.element = i), (this.id = 'shuffle_' + L), (L += 1), this._init(), (this.isInitialized = !0));
        }
        _init() {
            if (
        ...
        setItemTransitions(t) {
            const { speed: e, easing: i } = this.options,
                ...
                n = Object.keys(a.Css.HIDDEN.before).map((t) => t.replace(/([A-Z])/g, (t, e) => `-${e.toLowerCase()}`)),
                o = s.concat(n).join();
            t.forEach((t) => {
        ...
        _setColumns() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : w.getSize(this.element).width;
        ...
        _layout(t) {
            ...
            t.forEach((t, s) => {
                ...
                if (o.equals(t.point, e[s]) && !t.isHidden) return (t.applyCss(a.Css.VISIBLE.before), void n());
        ...
        _movementFinished() {
            ((this._transitions.length = 0), (this.isTransitioning = !1), this._dispatch(w.EventType.LAYOUT));
        }
        filter(t, e) {
            this.isEnabled &&
        ...
        destroy() {
            (this._cancelMovement(),
                this._resizeObserver && (this._resizeObserver.unobserve(this.element), (this._resizeObserver = null)),
        ...
        static _skipTransitions(t, e) {
            const i = t.map((t) => {
                const { style: e } = t,
                    ...
                    s = e.transitionDelay;
                return ((e.transitionDuration = '0ms'), (e.transitionDelay = '0ms'), { duration: i, delay: s });
            });
            (e(),
                t[0].offsetWidth,
                t.forEach((t, e) => {
