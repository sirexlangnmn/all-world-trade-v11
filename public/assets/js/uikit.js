...
(function (global, factory) {
    ...
    function within(element, selector) {
        return !isString(selector)
            ? element === selector ||
                  (isDocument(selector) ? selector.documentElement : toNode(selector)).contains(toNode(element)) // IE 11 document does not implement contains
        ...
        toNodes(element).forEach(function (ref) {
            ...
            for (var i = 0; i < args.length; i++) {
                supports.Force
                    ...
                    : classList[(!isUndefined(force) ? force : !classList.contains(args[i])) ? 'add' : 'remove'](
                          args[i],
                      );
            }
        });
    ...
    */
    ...
    function toggleHeight(ref) {
        ...
        return function (el, show) {
            ...
            var inner = el.hasChildNodes
                ? toFloat(css(el.firstElementChild, 'marginTop')) + toFloat(css(el.lastElementChild, 'marginBottom'))
                : 0;
    ...
    var Accordion = {
        ...
        methods: {
            toggle: function (item, animate) {
                ...
                item &&
                    [item].concat((!this.multiple && !includes(active, item) && active) || []).forEach(function (el) {
                        var isItem = el === item;
        ...
        methods: {
            ...
            position: function () {
                ...
                if (this.align === 'justify') {
                    ...
                    this.$el.offsetWidth > Math.max(boundary.right - alignTo.left, alignTo.right - boundary.left)
                ) {
        ...
        update: {
            read: function (ref) {
                ...
                if (this.expand) {
                    ...
                    minHeight =
                        height(window) - (offsetHeight(document.documentElement) - offsetHeight(this.$el)) - box || '';
                } else {
    ...
    function getPlaceholderImage(width, height, sizes) {
        ...
        if (sizes) {
            ((assign = Dimensions.ratio({ width: width, height: height }, 'width', toPx(sizesToPixel(sizes)))),
                (width = assign.width),
    ...
    var Navbar = {
        ...
        beforeConnect: function () {
            ...
            this.dropbar =
                dropbar && (query(dropbar, this.$el) || $('+ .uk-navbar-dropbar', this.$el) || $('<div></div>'));
                ...
                handler: function (e) {
                    ...
                    if (
                        ...
                        ((link = closest(e.target, 'a[href]')) &&
                            (this.cls || !isVisible(this.target) || (link.hash && matches(this.target, link.hash))))
                    ) {
                        e.preventDefault();
                    }
            ...
            updateNav: function () {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(
                        el,
                        'uk-invisible',
                        this$1.finite && ((cmd === 'previous' && i === 0) || (cmd === 'next' && i >= this$1.maxIndex)),
                    );
                });
            },
        },
    ...
    var Lightbox = {
        ...
        methods: {
            show: function (index) {
                ...
                this.panel =
                    this.panel || this.$create('lightboxPanel', assign({}, this.$props, { items: this.items }));
    ...
    function Transitioner$1(prev, next, dir, ref) {
        ...
        return {
            ...
            show: function (duration, percent, linear) {
                ...
                Transition.start(list, { transform: translate(-to * (isRtl ? -1 : 1), 'px') }, duration, timing).then(
                    deferred.resolve,
                    noop,
                );
    ...
    var Slider$1 = {
        ...
        computed: {
            ...
            finite: function (ref) {
                ...
                return (
                    finite ||
                    Math.ceil(getWidth(this.list)) < bounds(this.list).width + getMaxWidth(this.list) + this.center
                );
            },
        ...
        events: [
...

            {
                ...
                handler: function (ref) {
                    ...
                    Transition.start(this.$el, this.getCss(isIn(type) ? 0.5 : dir > 0 ? 1 : 0), duration, timing).catch(
                        noop,
                    );
                },
            },
    ...
    var Animations$2 = assign({}, Animations, {
        ...
        scale: {
            ...
            translate: function (percent) {
                return [{ opacity: 1 - percent, transform: scale3d(1 + 0.5 * percent), zIndex: 0 }, { zIndex: -1 }];
            },
        },
        ...
        methods: {
            ...
            move: function (e) {
                ...
                var target =
                    e.type === 'mousemove'
                        ? e.target
                        : document.elementFromPoint(this.pos.x - window.pageXOffset, this.pos.y - window.pageYOffset);
