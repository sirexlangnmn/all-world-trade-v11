            ...
            (l.prototype = {
                            ...
                            var z = function () {
                                ...
                                (y(),
                                    ...
                                    j.options.dropupAuto &&
                                        j.$newElement.toggleClass('dropup', f > g && b - w.vert < d),
                    ...
                    (c.data('spaceSelect', !1),
                        ...
                        this.$menuInner.on('click', 'li a', function (c) {
                            ...
                            if (
                                ...
                                if (b.multiple) {
                                    if (
                                        (k.prop('selected', !l), b.setSelected(f, !l), d.blur(), n !== !1 || o !== !1)
                                    ) {
                        ...
                        this.$searchbox.on('input propertychange', function () {
                            if (
                                ...
                                if (
                                    ...
                                    (d.html(
                                        c.options.noneResultsText.replace('{0}', '"' + j(c.$searchbox.val()) + '"'),
                                    ),
                ...
                keydown: function (b) {
                    ...
                    if (
                            ...
                            i.options.liveSearch
                                ? (b.preventDefault(),
                                  g.hasClass('dropdown-toggle') ||
                                      (c.removeClass('active').eq(d).addClass('active').children('a').focus(),
                                      g.focus()))
                        ...
                        ((c = i.$lis.filter(j)),
                            c.each(function (c) {
                                a.trim(a(this).children('a').text().toLowerCase()).substring(0, 1) == k[b.keyCode] &&
                                    n.push(c);
                            }),
