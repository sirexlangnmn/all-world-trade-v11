(function (a, b) {
    ...
    return function (a) {
        var b = Math.abs,
            ...
            w = [],
            x = 0,
            y = { gallery: [], slider: null, sliderElements: [], elementsLength: 0, currentIndex: 0, x: 0 },
            z = {},
            A = null,
            B = null,
            C = function (a) {
                    ...
                    init: function (a, b) {
                        ...
                        (b.appendChild(c),
                            (w[x] = new window.YT.Player(c, {
                                ...
                                playerVars: { controls: a.getAttribute('data-controls') || 1, rel: 0, playsinline: 1 },
                            })),
        ...
        var E = function (a) {
            ...
            da = function (a) {
                (a.stopPropagation(),
                    n && (a.preventDefault(), (k.endX = a.touches[0].pageX), (k.endY = a.touches[0].pageY), ia()));
            },
            ea = function (a) {
                (a.stopPropagation(),
                    (n = !1),
            ...
            ia = function () {
                ...
                0 < b(k.startX - k.endX) && !m && c.swipeClose
                    ? ((z[B].slider.style.transform = 'translate3d(' + (s - a(k.startX - k.endX)) + 'px, 0, 0)'),
                      (l = !0),
                      (m = !1))
                    : 0 < b(k.startY - k.endY) &&
                      !l &&
                      ((z[B].slider.style.transform = 'translate3d(' + s + 'px, -' + a(k.startY - k.endY) + 'px, 0)'),
                      (l = !1),
                      (m = !0));
            },
            ja = function () {
